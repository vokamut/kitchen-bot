...
enum CategoryEnum: int
{
    ...
    public static function getCaseByValue(int $value): self
    {
        return match ($value) {
            ...
            self::FIRST_COURSES_CHICKEN->value => self::FIRST_COURSES_CHICKEN,
            self::FIRST_COURSES_PORK->value => self::FIRST_COURSES_PORK,
            self::FIRST_COURSES_BEEF->value => self::FIRST_COURSES_BEEF,
            self::FIRST_COURSES_FISH->value => self::FIRST_COURSES_FISH,
            self::FIRST_COURSES_VEGETABLES->value => self::FIRST_COURSES_VEGETABLES,
            self::MAIN_COURSES_CHICKEN->value => self::MAIN_COURSES_CHICKEN,
            self::MAIN_COURSES_PORK->value => self::MAIN_COURSES_PORK,
            self::MAIN_COURSES_BEEF->value => self::MAIN_COURSES_BEEF,
            self::MAIN_COURSES_FISH->value => self::MAIN_COURSES_FISH,
            self::MAIN_COURSES_OFFAL->value => self::MAIN_COURSES_OFFAL,
            self::SALADS_CHICKEN->value => self::SALADS_CHICKEN,
            self::SALADS_PORK->value => self::SALADS_PORK,
            self::SALADS_BEEF->value => self::SALADS_BEEF,
            self::SALADS_FISH->value => self::SALADS_FISH,
            self::PREPARATIONS_BERRIES_FRUITS->value => self::PREPARATIONS_BERRIES_FRUITS,
            self::PREPARATIONS_VEGETABLES->value => self::PREPARATIONS_VEGETABLES,
        };
    }
